/** 
 * @description "ERROR" is list of all pre-defined error/message types formatted as "all cap w underline" style
 * @summary
 *  We can import this pre-defined "Errtypes" to prevent from mistyping
 *  To highlight Errtypes, regex search=`ERROR.\w+,`
 * @example
 * import {ERROR} from `@utils;
 *
 * [...]
 * case ERROR.CHANNEL_ADD=//* auto-complete, instead of manually typing `case "CHANNEL_ADD"`
 */
export enum ERROR {
  //* SECTION firebase
  /** @this getFCM () */
